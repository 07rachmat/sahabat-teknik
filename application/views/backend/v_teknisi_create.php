...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-12">
            <form action="<?= base_url('teknisi/create') ?>" method="post" enctype="multipart/form-data">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select name="jenis_kelamin" id="jenis_kelamin" class="form-control <?= form_error('no_telepon') ? 'is-invalid' : '' ?>">
