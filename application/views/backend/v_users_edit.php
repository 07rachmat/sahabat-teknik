...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-12">
            <form action="<?= base_url('users/edit/' . $data->id_user) ?>" method="post" enctype="multipart/form-data">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control <?= form_error('username') ? 'is-invalid' : '' ?>" id="username" name="username" placeholder="Username" value="<?= $data->username ?>">
                                    <div class="invalid-feedback">
                                        <?= form_error('username') ?>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select name="level" id="level" class="form-control <?= form_error('level') ? 'is-invalid' : '' ?>">
                                        ...
                                        <option value="teknisi" <?= $data->level == 'teknisi' ? 'selected' : '' ?>>Teknisi</option>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select <?= form_error('status_user') ? 'is-invalid' : '' ?>" id="status_user" name="status_user">
